...
public class HashMapDemo {
	...
	public static void main(String[] args) {
		...
		value = subjectMap.put("phyton", "45 days");
		System.out.println(value);// null
		...
		Set<String> subjectkeySet = subjectMap.keySet();
		System.out.println(subjectkeySet);
		...
		// Access values of element using for each loop
		...
		// return the previous value associated wiyh key,
		// or null there was nomapping for key
		value = subjectMap.remove("java");
		System.out.println(value);

		int size;
		// size()
		// returns the total number of element in this map
		...
		// replace (key, Value)
		// replaces the previoius value to the new value
		// which is mapped to the specified key
		// re

		value = subjectMap.replace("c++", "20 dayes");
		System.out.println(value);
